    ...
    "en": [
        {
            ...
            answer: (
                <Stack sx={cardStyle}>
                    <Typography variant='body1'>Cryptocurrency is a form of digital currency that operates on a decentralized blockchain network, providing fast, secure, and anonymous transactions. At Drifbet, we support several major cryptocurrencies, allowing players to deposit and withdraw without the need for traditional banks or intermediaries. Popular cryptocurrencies such as Bitcoin and Ethereum can be used to fund your account, place bets, and cash out winnings directly to your crypto wallet.</Typography>
                </Stack>
            )
        },
        {
            question: "2. How to Use Cryptocurrency on Drifbet",
            answer: (
                <Stack sx={cardStyle}>
                    <Stack gap={1} width="100%">
                        <Typography variant='h6' >Step 1: Create or Log In to Your Drifbet Account</Typography>
                        <Typography variant='body1'>{`If you don't already have an account, sign up on Drifbet. For existing players, simply log in.`}</Typography>
                        ...
                        <Typography variant='h6' >Step 4: Deposit Cryptocurrency into Your Drifbet Account</Typography>
                        <Typography variant='body1'>Head to the deposit section on Drifbet and choose <Box component="span" sx={titleColor} fontWeight="bold">Cryptocurrency</Box> as your payment option. The casino will provide you with a <Box component="span" sx={titleColor} fontWeight="bold">wallet address</Box> (a unique string of letters and numbers). Open your crypto wallet, paste the casino’s wallet address, and transfer the desired amount of cryptocurrency. Depending on the cryptocurrency network’s traffic, the transaction will be confirmed within minutes, and your account balance will be updated accordingly.</Typography>
                        <Typography variant='h6' >Step 5: Withdraw Your Winnings in Cryptocurrency</Typography>
                        <Typography variant='body1'>When you’re ready to cash out, simply request a withdrawal through the same cryptocurrency method. Drifbet will process your request and send the funds to your wallet address. Withdrawals are typically fast, though processing times may vary depending on the network and internal reviews.</Typography>
                    </Stack>
                </Stack>
            )
        },
        {
            question: "3. Benefits of Using Cryptocurrency at Drifbet",
            answer: (
                <Stack sx={cardStyle}>
                    <Typography variant='h6' >a. Security and Privacy</Typography>
                    <Typography variant='body1'>Cryptocurrency transactions at Drifbet are highly secure and encrypted. There’s no need to share sensitive bank details, as all transactions are conducted through the blockchain, providing an extra layer of anonymity and protection.</Typography>
                    ...
                    <Typography variant='body1'>Cryptocurrency allows players from all around the world to access Drifbet without facing geographic or banking restrictions. Players in regions where traditional banking options may be limited can easily deposit and withdraw using crypto, bypassing local regulations that may affect fiat currency gambling.</Typography>
                    <Typography variant='h6' >f. Special Bonuses and Promotions</Typography>
                    <Typography variant='body1'>Drifbet offers exclusive promotions and bonuses tailored for cryptocurrency users. You may be eligible for enhanced deposit bonuses, lower wagering requirements, or access to exclusive tournaments just for using Bitcoin or Ethereum.</Typography>
                </Stack>
            )
        },
    ],
    ...
    "ru": [
        {
            ...
            "answer": (
                <Stack sx={cardStyle}>
                    <Typography variant='body1'>Криптовалюта — это форма цифровой валюты, которая работает на децентрализованной блокчейн-сети, обеспечивая быстрые, безопасные и анонимные транзакции. В Drifbet мы поддерживаем несколько основных криптовалют, позволяя игрокам вносить и выводить средства без необходимости использовать традиционные банки или посредников. Популярные криптовалюты, такие как Bitcoin и Ethereum, могут использоваться для пополнения вашего счета, размещения ставок и вывода выигрышей напрямую на ваш криптокошелек.</Typography>
                </Stack>
            )
        },
        {
            "question": "2. Как использовать криптовалюту на Drifbet",
            "answer": (
                <Stack sx={cardStyle}>
                    <Stack gap={1} width="100%">
                        <Typography variant='h6'>Шаг 1: Создайте или войдите в свой аккаунт Drifbet</Typography>
                        <Typography variant='body1'>Если у вас еще нет аккаунта, зарегистрируйтесь на Drifbet. Для существующих игроков просто войдите в систему.</Typography>
                        ...
                        <Typography variant='h6'>Шаг 4: Внесите криптовалюту на свой аккаунт Drifbet</Typography>
                        <Typography variant='body1'>Перейдите в раздел пополнения на Drifbet и выберите <Box component="span" sx={titleColor} fontWeight="bold">Криптовалюту</Box> в качестве метода оплаты. Казино предоставит вам <Box component="span" sx={titleColor} fontWeight="bold">адрес кошелька</Box> (уникальная строка из букв и цифр). Откройте свой криптокошелек, вставьте адрес кошелька казино и переведите желаемую сумму криптовалюты. В зависимости от загруженности сети криптовалюты транзакция будет подтверждена в течение нескольких минут, и ваш баланс будет обновлен соответственно.</Typography>
                        <Typography variant='h6'>Шаг 5: Выведите свои выигрыши в криптовалюте</Typography>
                        <Typography variant='body1'>Когда вы будете готовы вывести средства, просто запросите вывод через тот же метод криптовалюты. Drifbet обработает ваш запрос и отправит средства на ваш адрес кошелька. Выводы обычно происходят быстро, хотя время обработки может варьироваться в зависимости от сети и внутренних проверок.</Typography>
                    </Stack>
                </Stack>
            )
        },
        {
            "question": "3. Преимущества использования криптовалюты на Drifbet",
            "answer": (
                <Stack sx={cardStyle}>
                    <Typography variant='h6'>a. Безопасность и конфиденциальность</Typography>
                    <Typography variant='body1'>Транзакции с криптовалютой на Drifbet являются высокозащищенными и зашифрованными. Нет необходимости делиться конфиденциальными банковскими данными, так как все транзакции проводятся через блокчейн, обеспечивая дополнительный уровень анонимности и защиты.</Typography>
    ...
    "nb": [
        {
            ...
            "answer": (
                <Stack sx={cardStyle}>
                    <Typography variant='body1'>Kryptovaluta er en form for digital valuta som opererer på et desentralisert blockchain-nettverk, og tilbyr raske, sikre og anonyme transaksjoner. Hos Drifbet støtter vi flere store kryptovalutaer, slik at spillere kan sette inn og ta ut uten behov for tradisjonelle banker eller mellomledd. Populære kryptovalutaer som Bitcoin og Ethereum kan brukes til å finansiere kontoen din, plassere innsatser og ta ut gevinster direkte til kryptovaluta-lommeboken din.</Typography>
                </Stack>
            )
        },
        {
            "question": "2. Hvordan bruke kryptovaluta på Drifbet",
            "answer": (
                <Stack sx={cardStyle}>
                    <Stack gap={1} width="100%">
                        <Typography variant='h6'>Trinn 1: Opprett eller logg inn på din Drifbet-konto</Typography>
                        <Typography variant='body1'>Hvis du ikke allerede har en konto, registrer deg på Drifbet. For eksisterende spillere, logg inn.</Typography>
        ...
        },
        {
            ...
            "answer": (
                <Stack sx={cardStyle}>
                    ...
                    <Typography variant='body1'>Kryptovaluta gjør det mulig for spillere fra hele verden å få tilgang til Drifbet uten å møte geografiske eller bankmessige begrensninger. Spillere i regioner hvor tradisjonelle bankalternativer kan være begrenset, kan enkelt sette inn og ta ut penger ved hjelp av kryptovaluta, og omgå lokale forskrifter som kan påvirke gambling med fiat-valuta.</Typography>
                    <Typography variant='h6'>f. Spesielle Bonuser og Kampanjer</Typography>
                    <Typography variant='body1'>Drifbet tilbyr eksklusive kampanjer og bonuser skreddersydd for brukere av kryptovaluta. Du kan være berettiget til forbedrede innskuddsbonuser, lavere omsetningskrav eller tilgang til eksklusive turneringer bare for å bruke Bitcoin eller Ethereum.</Typography>
                </Stack>
            )
        }
    ],
    "fi": [
        {
            ...
            "answer": (
                <Stack sx={cardStyle}>
                    <Typography variant='body1'>Kryptovaluutta on digitaalisen valuutan muoto, joka toimii hajautetulla lohkoketjuverkolla, tarjoten nopeita, turvallisia ja anonyymejä transaktioita. Drifbet:ssä tuemme useita suuria kryptovaluuttoja, jolloin pelaajat voivat tallettaa ja nostaa varoja ilman perinteisten pankkien tai välikäsien tarvetta. Suosittuja kryptovaluuttoja, kuten Bitcoin ja Ethereum, voidaan käyttää tilin rahoittamiseen, vetoamiseen ja voittojen nostamiseen suoraan kryptolompakkoon.</Typography>
                </Stack>
            )
        },
        {
            "question": "2. Kuinka käyttää kryptovaluuttaa Drifbet:ssa",
            "answer": (
                <Stack sx={cardStyle}>
                    <Stack gap={1} width="100%">
                        <Typography variant='h6'>Vaihe 1: Luo tai kirjaudu Drifbet-tilillesi</Typography>
                        <Typography variant='body1'>Jos sinulla ei vielä ole tiliä, rekisteröidy Drifbet:een. Nykyisten pelaajien tulee vain kirjautua sisään.</Typography>
                        ...
                        <Typography variant='h6'>Vaihe 4: Talleta kryptovaluuttaa Drifbet-tilillesi</Typography>
                        <Typography variant='body1'>Siirry Drifbet:n talletusosioon ja valitse <Box component="span" sx={titleColor} fontWeight="bold">Kryptovaluutta</Box> maksuvaihtoehtona. Kasino antaa sinulle <Box component="span" sx={titleColor} fontWeight="bold">lompakko-osoitteen</Box> (ainutlaatuinen merkkijono). Avaa kryptolompakkosi, liitä kasinon lompakko-osoite ja siirrä haluamasi määrä kryptovaluuttaa. Riippuen kryptovaluuttaverkon liikenteestä, transaktio vahvistetaan muutamassa minuutissa, ja tilisi saldo päivitetään vastaavasti.</Typography>
                        <Typography variant='h6'>Vaihe 5: Nosta voitot kryptovaluutassa</Typography>
                        <Typography variant='body1'>Kun olet valmis nostamaan, pyydä vain nostoa saman kryptovaluuttamenetelmän kautta. Drifbet käsittelee pyyntösi ja lähettää varat lompakko-osoitteeseesi. Nostot ovat yleensä nopeita, vaikka käsittelyajat voivat vaihdella verkon ja sisäisten tarkastusten mukaan.</Typography>
                    </Stack>
                </Stack>
            )
        },
        {
            "question": "3. Kryptovaluutan käytön edut Drifbet:ssa",
            "answer": (
                <Stack sx={cardStyle}>
                    <Typography variant='h6'>a. Turvallisuus ja yksityisyys</Typography>
                    <Typography variant='body1'>Kryptovaluuttatransaktiot Drifbet:ssa ovat erittäin turvallisia ja salattuja. Herkkiä pankkitietoja ei tarvitse jakaa, sillä kaikki transaktiot suoritetaan lohkoketjun kautta, mikä tarjoaa lisäkerroksen anonymiteettiä ja suojaa.</Typography>
        ...
        },
        {
            ...
            "answer": (
                <Stack sx={cardStyle}>
                    ...
                    <Typography variant='body1'>Kryptovaluta gör det möjligt för spelare från hela världen att få tillgång till Drifbet utan att möta geografiska eller bankrelaterade begränsningar. Spelare i regioner där traditionella bankalternativ kan vara begränsade kan enkelt sätta in och ta ut med kryptovaluta, vilket kringgår lokala regler som kan påverka spel med fiat-valuta.</Typography>
                    <Typography variant='h6'>f. Speciella bonusar och kampanjer</Typography>
                    <Typography variant='body1'>Drifbet erbjuder exklusiva kampanjer och bonusar anpassade för kryptovaluta-användare. Du kan vara berättigad till förbättrade insättningsbonusar, lägre omsättningskrav eller tillgång till exklusiva turneringar bara för att använda Bitcoin eller Ethereum.</Typography>
                </Stack>
            )
        }
    ],
        ...
        },
        {
            ...
            "answer": (
                <Stack sx={cardStyle}>
                    ...
                    <Typography variant='body1'>Las criptomonedas permiten a jugadores de todo el mundo acceder a Drifbet sin enfrentar restricciones geográficas o bancarias. Los jugadores en regiones donde las opciones bancarias tradicionales pueden estar limitadas pueden depositar y retirar fácilmente usando criptomonedas, eludiendo las regulaciones locales que pueden afectar el juego con moneda fiat.</Typography>
                    <Typography variant='h6'>f. Bonos y Promociones Especiales</Typography>
                    <Typography variant='body1'>Drifbet ofrece promociones y bonos exclusivos diseñados para usuarios de criptomonedas. Puedes ser elegible para bonos de depósito mejorados, requisitos de apuesta más bajos o acceso a torneos exclusivos solo por usar Bitcoin o Ethereum.</Typography>
                </Stack>
            )
        }
    ],
    "de": [
        {
            ...
            "answer": (
                <Stack sx={cardStyle}>
                    <Typography variant='body1'>Kryptowährung ist eine Form der digitalen Währung, die auf einem dezentralen Blockchain-Netzwerk basiert und schnelle, sichere und anonyme Transaktionen ermöglicht. Bei Drifbet unterstützen wir mehrere große Kryptowährungen, sodass Spieler Einzahlungen vornehmen und Auszahlungen tätigen können, ohne auf traditionelle Banken oder Vermittler angewiesen zu sein. Beliebte Kryptowährungen wie Bitcoin und Ethereum können verwendet werden, um Ihr Konto zu finanzieren, Wetten zu platzieren und Gewinne direkt an Ihre Krypto-Wallet abzuheben.</Typography>
                </Stack>
            )
        },
        {
            "question": "2. Wie verwendet man Kryptowährung bei Drifbet?",
            "answer": (
                <Stack sx={cardStyle}>
                    <Stack gap={1} width="100%">
                        <Typography variant='h6' >Schritt 1: Erstellen Sie ein Drifbet-Konto oder melden Sie sich an</Typography>
                        <Typography variant='body1'>Wenn Sie noch kein Konto haben, melden Sie sich bei Drifbet an. Für bestehende Spieler melden Sie sich einfach an.</Typography>
            ...
            "answer": (
                <Stack sx={cardStyle}>
                    <Stack gap={1} width="100%">
                        ...
                        <Typography variant='h6'>Étape 4 : Déposez de la cryptomonnaie sur votre compte Drifbet</Typography>
                        <Typography variant='body1'>Allez dans la section dépôt sur Drifbet et choisissez <Box component="span" sx={titleColor} fontWeight="bold">Cryptomonnaie</Box> comme option de paiement. Le casino vous fournira une <Box component="span" sx={titleColor} fontWeight="bold">adresse de portefeuille</Box> (une chaîne unique de lettres et de chiffres). Ouvrez votre portefeuille crypto, collez l&apos;adresse du portefeuille du casino et transférez le montant de cryptomonnaie souhaité. En fonction de l&apos;afflux du réseau de la cryptomonnaie, la transaction sera confirmée en quelques minutes et votre solde sera mis à jour en conséquence.</Typography>
                        <Typography variant='h6'>Étape 5 : Retirer vos gains en cryptomonnaie</Typography>
                        <Typography variant='body1'>Lorsque vous êtes prêt à retirer, demandez simplement un retrait via le même mode de cryptomonnaie. Drifbet traitera votre demande et enverra les fonds à votre adresse de portefeuille. Les retraits sont généralement rapides, bien que les délais de traitement puissent varier en fonction du réseau et des revues internes.</Typography>
                    </Stack>
                </Stack>
            )
        },
        {
            "question": "3. Avantages d'utiliser la cryptomonnaie sur Drifbet",
            "answer": (
                <Stack sx={cardStyle}>
                    <Typography variant='h6'>a. Sécurité et confidentialité</Typography>
                    <Typography variant='body1'>Les transactions en cryptomonnaie sur Drifbet sont hautement sécurisées et cryptées. Il n&apos;est pas nécessaire de partager des informations bancaires sensibles, car toutes les transactions sont effectuées via la blockchain, offrant une couche supplémentaire d&apos;anonymat et de protection.</Typography>
                    ...
                    <Typography variant='body1'>Drifbet offre des promotions et des bonus exclusifs réservés aux utilisateurs de cryptomonnaies. Vous pouvez être éligible à des bonus de dépôt améliorés, des exigences de mise réduites ou l&apos;accès à des tournois exclusifs simplement en utilisant Bitcoin ou Ethereum.</Typography>
                </Stack>
            )
        }
    ]
